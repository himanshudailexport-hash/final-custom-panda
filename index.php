...
<body>
    ...
    <div class="px-4">
        <section id="hero">
            <h4><i class="fa-solid fa-bolt"></i>Fast and Quality Service</h4>
            <h2>Because their</h2>
            <h2>name deserves</h2>
            <h2>more than just a</h2>
            <h1>TAG</h1>
            <p class="hero-p">"Welcome to Custom Panda Store, where <br> your ideas come to life on fabric! Whether <br>it's
                bold
                statements,
                funny
                slogans, or <br> unique designs, we create custom T-shirts <br> that match your style. Design your own or
                <br> choose from
                our exclusive collection— <br>because every T-shirt should tell a story. <br>
        ...
        <div class="fe-box">
            <img src="assets/img/featurebox/fe-box.jpeg" alt="features box">
            <h6>Free Shipping</h6>
        </div>
        <div class="fe-box">
            <img src="assets/img/featurebox/fe-box.jpeg" alt="features box">
